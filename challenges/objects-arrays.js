...
const contactInfo = [];
let gradNames = graduates.forEach(function (i){
...
*/
const animalNames = [];
let bothNames = zooAnimals.forEach(function(zooAnimal){
  animalNames.push(zooAnimal.scientific_name + " " + zooAnimal.animal_name);
